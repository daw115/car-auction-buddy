...
import { criteriaSchema, parseCriteria as parseCriteriaPure } from "@/lib/criteria-schema";

/**
 * Wrapper nad pure parserem z `@/lib/criteria-schema` — dokleja logowanie
 * nieznanych pól do strumienia /dev/logs (server-only side effect).
 */
